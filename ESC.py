...
os.system ("sudo killall pigpiod") #Launching GPIO librarycalibrate

os.system ("sudo pigpiod") #Launching GPIO library
time.sleep(1) # As i said it is too impatient and so if this delay is removed you will get an error
import pigpio #importing GPIO library

mot1=5  #Connect the ESC in this GPIO pin 
mot2=6  #Connect the ESC in this GPIO pin 
mot3=13  #Connect the ESC in this GPIO pin 
mot4=19  #Connect the ESC in this GPIO pin 
...
def manual_drive(): #You will use this function to program your ESC if required
    ...
    while True:
        ...
        if inp == "stop":
            ...
            pi.set_servo_pulsewidth(mot1, inp) 
            pi.set_servo_pulsewidth(mot2, inp) 
            pi.set_servo_pulsewidth(mot3, inp) 
            pi.set_servo_pulsewidth(mot4, inp)
